...
@section('script')
    ...
    @isset($ttchuyenxe)
        <script>
			...
			document.forms["ttchuyenxe"]["xe"].onchange = function(ev){
				$('#alertmessage .modal-body').html("Cảnh báo: Thay đổi xe sử dụng trong chuyến xe sẽ reset dữ liệu đặt vé của chuyến xe!");
				$('#alertmessage').modal('show');
			};
        </script>
    @endisset
